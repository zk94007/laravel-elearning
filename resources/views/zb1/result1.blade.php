   ...
   <nav data-equalizer>
      ...
      <div class="row">
        <div class="large-12-columns">
          <?php if($resultLesen > 59) { ?>
          <div class="pyro {{$pyrocolor}}">
            <div class="before"></div>
            <div class="after"></div>
          </div>
      	<?php }?>
      	<?php if($resultLesen > 69) { ?>
      		<script>
				initParallax();
			</script>
            ...
            <div class="txt-container layer" data-depth="0.25">
              ...
              <div class="percentage-display">{{ $resultLesen }}</div>
            </div>
      ...
      <h5 class="text-center">Auswertung Lesen</h5>
      		<?php if($resultLesen < 60) { ?>
      			<p>Sie haben  <b>{{ $resultLesen }}</b> von 100 Punkten erreicht.<br/>
      ...
      <div class="row medium-up-1">
        ...
        <a  onClick="loadQuestion('zb1',7);$('.title-cnt').html('<h4><b>Zertifikat B1</b> Modellsatz Hören</h4>');" class="nav-button next" data-equalizer-watch>
